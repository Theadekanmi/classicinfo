     ...
     <main>
      ...
      <section className="bg-gray-900 py-12 -mt-5">
        <div className="container mx-auto px-4">
          <h1 className=" text-cyan-900 text-2xl sm:text-3xl md:text-5xl text-center font-bold  mb-3 md:mb-4">Our Services</h1>
          <p className="text-gray-100 text-1xl sm:text-1xl md:text-1xl text-center mb-3 md:mb-4">
